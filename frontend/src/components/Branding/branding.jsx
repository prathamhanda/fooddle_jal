        ...
        <div className="bg-white/90 backdrop-blur-lg text-indigo-900 p-8 border border-white/20 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600 text-sm">We'll automatically save this to our secure database and proceed to payment</p>
                </div>
                ...
                {/* Info Box */}
                <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-2xl border border-green-100">
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm text-gray-600">
                            <p className="font-medium text-green-800 mb-1">Secure Remote Storage</p>
                            <ul className="space-y-1 text-gray-600">
                                <li>• Phone numbers saved to secure Google Sheets</li>
                                <li>• Accessible to developers for customer support</li>
                                <li>• No downloads required on user device</li>
